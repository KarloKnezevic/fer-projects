...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Nov 14 20:31:04 CET 2009
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\012\000\004\052\005\001\002\000\010\002\013\004" +
    "\007\006\010\001\002\000\006\004\007\006\010\001\002" +
    "\000\004\052\011\001\002\000\006\052\ufffe\053\ufffe\001" +
    "\002\000\006\052\ufffd\053\ufffd\001\002\000\010\002\000" +
    "\004\000\006\000\001\002\000\004\053\014\001\002\000" +
    "\004\002\001\001\002\000\010\002\uffff\004\uffff\006\uffff" +
    "\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\012\000\004\002\003\001\001\000\004\003\011\001" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		Object n1 = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new TreeNode("operator", new Object[]{n1}); 
		...
		Object n1 = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new TreeNode("operator", new Object[]{n1}); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // program ::= program operator CONST_INT 
            {
              Object RESULT =null;
		...
		Object n3 = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new TreeNode("program", new Object[]{n1, n2, n3}); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("program",0, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 1: // program ::= IDN operator IDN 
            {
              Object RESULT =null;
		int n1left = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int n1right = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
