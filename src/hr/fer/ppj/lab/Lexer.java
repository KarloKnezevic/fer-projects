/* The following code was generated by JFlex 1.4.3 on 12/11/09 23:43 */
...
class Lexer implements java_cup.runtime.Scanner {
  ...
  private Token newToken(Token.Type type, String value) {
      ...
      Token token;
      if(value=="(") {
    	  token = new Token(type, i, sym.L_OBICNA_ZAGRADA);
      }else if(value==")") {
    	  token = new Token(type, i, sym.D_OBICNA_ZAGRADA);
      }else if(value=="+") {
    	  token = new Token(type, i, sym.PLUS);
      } else {
    	  token = new Token(type, i);
      }
      token.setCol(yycolumn);
      token.setLine(yyline);
      tokenList.add(token);
